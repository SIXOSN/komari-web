...
SIXOSN Komari Web is the administration and public frontend maintained for the [`SIXOSN/komari`](https://github.com/SIXOSN/komari) distribution.
...
- 管理界面同步嵌入 SIXOSN Glassmorphism 默认主题。
